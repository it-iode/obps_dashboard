"""
Django settings for arqueomonitor project.
...
ALLOWED_HOSTS = ['127.0.0.1','dashboard.oceanbestpractices.org']
...
ROOT_URLCONF = 'obps_dashboard.urls'
...
WSGI_APPLICATION = 'obps_dashboard.wsgi.application'
